    ...
    return (
        <div className="grid grid-cols-1 xl:grid-cols-[2fr_3fr] border border-slate-300 rounded-lg p-8 gap-8">
            ...
            <div className="grid grid-rows-[1fr_2fr_1fr] ">
                ...
                <div className="grid grid-cols-[3fr_1fr] items-end whitespace-nowrap">
                    ...
                    <div className="flex flex-col items-end gap-1">
                        <span className="font-bold">{hotel.pricePerNight} Rs</span>
                        <Link to={`/detail/${hotel._id}`} className="bg-blue-600 text-white h-full p-2 font-bold text-x1 max-w-fit hover:bg-blue-500">View More</Link>
                    </div>
                </div>
            </div>
        </div>
